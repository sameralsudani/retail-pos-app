    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[80vh] overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">{t('customer.title')}</h2>
          <button
            onClick={onClose}
          ...
          {!showAddForm ? (
            <>
              ...
              <div className="max-h-64 overflow-y-auto space-y-2">
                ...
                >
                  <div className="font-medium text-gray-900">{t('customer.walk.in')}</div>
                  <div className="text-sm text-gray-500">{t('customer.walk.in.desc')}</div>
                </button>
