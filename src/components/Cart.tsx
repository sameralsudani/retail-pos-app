  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="px-4 sm:px-6 py-3 border-b border-gray-200 flex items-center justify-between">
        <span className="text-sm text-gray-600">{t('cart.items.in.cart')}</span>
        <button
          onClick={onClearCart}
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-2 sm:p-3 space-y-2 sm:space-y-3">
          {items.map((item) => (
            <div key={item.product.id} className="bg-gray-50 rounded-lg p-2 sm:p-3 hover:bg-gray-100 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between">
                    ...
                    <button
                      ...
                      className="ml-1 sm:ml-2 text-gray-400 hover:text-red-600 p-1 hover:bg-red-50 rounded transition-colors flex-shrink-0"
                    >
                      <X className="h-3 w-3" />
                    </button>
                  </div>
