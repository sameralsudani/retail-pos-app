...
const UsersPage = () => {
  ...
  const filteredUsers = users.filter(systemUser => {
    ...
    const matchesStatus = statusFilter === 'all' || systemUser.status === statusFilter;
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">{t('users.access.denied.title')}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">{t('users.stats.managers')}</p>
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500">{systemUser.employeeId}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{systemUser.email}</div>
                      <div className="text-sm text-gray-500">{systemUser.phone}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          {filteredUsers.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">{t('users.empty.subtitle')}</p>
            </div>
          )}
        </div>
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-900">{t('users.add.title')}</h2>
              <button
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <select
                  value={newUser.role}
                  onChange={(e) => setNewUser(prev => ({ ...prev, role: e.target.value as 'admin' | 'manager' | 'cashier' }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
                  <option value="cashier">{t('auth.role.cashier')}</option>
                  <option value="manager">{t('auth.role.manager')}</option>
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={canEdit ? (e) => setSelectedUser(prev => prev ? ({ ...prev, name: e.target.value }) : null) : undefined}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  disabled={!canEdit}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={canEdit ? (e) => setSelectedUser(prev => prev ? ({ ...prev, email: e.target.value }) : null) : undefined}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  disabled={!canEdit}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={canEdit ? (e) => setSelectedUser(prev => prev ? ({ ...prev, phone: e.target.value }) : null) : undefined}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  disabled={!canEdit}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={canEdit ? (e) => setSelectedUser(prev => prev ? ({ ...prev, employeeId: e.target.value }) : null) : undefined}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  disabled={!canEdit}
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={canEdit ? (e) => setSelectedUser(prev => prev ? ({ ...prev, role: e.target.value as 'admin' | 'manager' | 'cashier' }) : null) : undefined}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  disabled={!canEdit}
                >
                  <option value="cashier">{t('auth.role.cashier')}</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={canEdit ? (e) => setSelectedUser(prev => prev ? ({ ...prev, status: e.target.value as 'active' | 'inactive' }) : null) : undefined}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  disabled={!canEdit}
                >
                  <option value="active">{t('users.status.active')}</option>
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                <div className="text-sm text-gray-600">
                  <p>{t('users.info.last.login')}: <span className="font-medium">{selectedUser.lastLogin.toLocaleString()}</span></p>
                  <p>{t('users.info.created')}: <span className="font-medium">{selectedUser.createdAt.toLocaleDateString()}</span></p>
                  <p>{t('users.info.updated')}: <span className="font-medium">{selectedUser.updatedAt.toLocaleDateString()}</span></p>
                </div>
              </div>
            </div>
