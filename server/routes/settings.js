...
router.put(
  ...
  [
    ...
    body("storeAddress")
      ...
      .trim()
      .isLength({ max: 200 })
      .withMessage("Store address cannot exceed 200 characters"),
    body("storePhone")
      .optional()
      .trim()
      .isLength({ max: 20 })
    ...
    body("receiptHeader")
      ...
      .trim()
      .isLength({ max: 200 })
      .withMessage("Receipt header cannot exceed 200 characters"),
    body("receiptFooter")
      .optional()
      .trim()
      .isLength({ max: 200 })
      .withMessage("Receipt footer cannot exceed 200 characters"),
    body("printLogo")
      .optional()
      .isBoolean()
      .withMessage("Print logo must be boolean"),
    body("autoprint")
      .optional()
      .isBoolean()
      .withMessage("Auto print must be boolean"),
    body("currency")
      .optional()
      .isIn(["USD", "IQD"])
    ...
    body("soundEffects")
      .optional()
      .isBoolean()
      .withMessage("Sound effects must be boolean"),
    body("sessionTimeout")
      .optional()
      .isInt({ min: 5, max: 480 })
    ...
    body("requirePasswordChange")
      .optional()
      .isBoolean()
      .withMessage("Require password change must be boolean"),
    body("twoFactorAuth")
      .optional()
      .isBoolean()
    ...
    body("compactMode")
      .optional()
      .isBoolean()
      .withMessage("Compact mode must be boolean"),
    body("showProductImages")
      .optional()
      .isBoolean()
      .withMessage("Show product images must be boolean"),
  ],
  async (req, res) => {
    try {
      // Extract tenantId from user (handle both populated and non-populated)
